...
rtds_action_github_repo = "grburgess/wriggle"
...
latex_documents = [
    (master_doc, 'wriggle.tex', u'Wriggle Documentation',
...
man_pages = [(master_doc, 'wriggle', u'Wriggle Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'wriggle', u'Wriggle Documentation', author, 'wriggle',
